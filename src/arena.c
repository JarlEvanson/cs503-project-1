...
bool arena_alloc_from_unaligned() {
    Arena arena;
...
TestDefinition arena_tests[] = {
    DEFINE_TEST(arena_alloc_from_unaligned, 0),
    DEFINE_TEST(arena_alloc_can_fill, 0),
};

TestList arena_def = (TestList) {
    arena_tests,
    countof(arena_tests)
};
