...
TestDefinition lexer_tests[] = {
    DEFINE_TEST(lexer_lex_nothing, 1),
    DEFINE_TEST(lexer_lex_nil, 1),
    DEFINE_TEST(lexer_lex_numbers, 1),
    DEFINE_TEST(lexer_lex_strange_symbols, 1),
    DEFINE_TEST(lexer_lex_complex_escapes, 1),
    DEFINE_TEST(lexer_lex_string_suffix, 1),
    DEFINE_TEST(lexer_lex_unterminated_string, 1),
    DEFINE_TEST(lexer_lex_utf8_error, 1),
};
