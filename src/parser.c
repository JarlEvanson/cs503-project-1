...
TestDefinition parser_tests[] = {
    DEFINE_TEST(parser_parse_nil, 1),
    DEFINE_TEST(parser_parse_double_nil, 1),
    DEFINE_TEST(parser_parse_basic_symbols, 1),
    DEFINE_TEST(parser_parse_simple_list, 1),
    DEFINE_TEST(parser_skip_right_parens, 1),
};
